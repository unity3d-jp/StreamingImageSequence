...
//----------------------------------------------------------------------------------------------------------------------
    internal void SetOwner(SISClipData owner) {  m_sisClipDataOwner = owner;}
    internal SISClipData GetOwner() {  return m_sisClipDataOwner; }    
...
//----------------------------------------------------------------------------------------------------------------------
    ...
    [NonSerialized]                   private SISClipData                     m_sisClipDataOwner = null;
