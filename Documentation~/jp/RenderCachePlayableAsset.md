...
あるいは上書きされないようにフレームをロックするために使います。
...
* **Delete**：　未使用
* **Lock and Edit**  
  フレームをロックし、 アサインされた [image application](https://docs.unity3d.com/ja/current/Manual/Preferences.html#External-Tools)
　でフレームを開きます。デフォルトのショートカットは *Alt + E* で
